...
const AboutMe = () => {
  ...
  return (
    <div className='flex flex-col text-start items-center justify-center text-black dark:text-white overflow-hidden w-full h-full shadow-md  isolate pt-3 lg:pt-0 select-none'>
      <article className='  w-full h-full flex flex-col text-start gap-4 items-start justify-start  max-h-[95%] overflow-y-scroll pb-10 no-scrollbar'> 
        <div className='flex flex-col w-full h-fit items-center'>
          <header className='flex  flex-col w-full h-fit border-b border-primaryBorderColor dark:border-secondaryBorderColor px-4 pb-4 pt-2 '>
            <h2
              className='select-none gradient-title-line m-0 text-[25px] font-bold'
              draggable='false'
            >
              {t('aboutMe')}
            </h2>
          ...
          <section className='flex flex-col sm:grid sm:grid-cols-2 w-full px-4   gap-2 relative'>
            ...
            <span className='hidden sm:flex vertical-gradient-line absolute left-[50%] h-[100%] w-[1px]  flex-col items-center justify-center text-center rounded-[10%]'></span>
            <div className='flex flex-col w-full h-full text-start items-center justify-center p-4 '>
              <section className='flex flex-row text-start justify-between w-full h-fit items-center '>
                ...
                <small className='text-[15px]'>28</small>
              </section>
              ...
              <section className='flex flex-row text-start justify-between w-full h-fit items-center '>
                ...
                <small className='text-[15px] flex text-end '>
                  Misiones, Paraguay
                </small>
              </section>
              <span className='gradient-line-span  w-[100%] flex flex-col items-center justify-center text-center h-[1px] my-2  rounded-[10%]'></span>
