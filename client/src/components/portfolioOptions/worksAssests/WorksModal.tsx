    ...
    wallStIntel: {
      ...
      description:
        i18n.language === "en"
          ...
          : "Desarrollé interfaces en React con TypeScript y Tailwind, integrando Asynchronous Redux Toolkit para una gestión robusta del estado. Diseñé una experiencia centrada en el usuario, recuperando y formateando datos analíticos para los componentes de React. Gráficos y tablas implementadas para proporcionar a los usuarios una representación intuitiva y visualmente atractiva. Implemente la virtualización de listas para mejorar la eficiencia del renderizado de grandes conjuntos de datos, lo que resulto en una mejora del rendimiento en un 15%. Garanticé interfaces accesibles y receptivas para una experiencia de usuario óptima. Trabajé en colaboración con el equipo de backend para diseñar estructuras de datos para más de 5 productos de la página, permitiendo una integración fluida. Diseñé una arquitectura de código escalable mediante componentes reutilizables para una eficiencia mejorada.",
      id: 0,
