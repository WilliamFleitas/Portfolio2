...
const Typewriter: React.FC<TypewriterProps> = ({
  ...
  return (
    <div
      className='typewriter-effect h-6 min-h-6 m-0 text-primaryButtonColor  text-start items-center justify-center flex flex-col text-[1.2rem] font-bold'
      style={{
        textShadow: '-2px 2px 6px #0000008c'
      }}
    >
