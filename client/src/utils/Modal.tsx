  ...
  return (
    <Transition.Root show={isOpen} as={Fragment}>
      ...
      >
        ...
        <div className="fixed inset-0 z-10 w-full h-full overflow-y-auto md:p-4 ">
          <div className="flex flex-col w-full h-full  items-center justify-center  text-start   md:p-4 rounded-md">
            ...
            >
              ...
              className="relative no-scrollbar w-full h-full sm:max-w-[75vw] md:max-w-[60vw]  sm:max-h-[85vh] sm:min-h-[50px]  overflow-x-hidden  overflow-y-scroll sm:rounded-md sm:isolate"> 
